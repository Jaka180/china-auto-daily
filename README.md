...
git add -A && git commit -m "init pipeline"
# 在 GitHub 新建一个【私有】仓库，然后：
git remote add origin git@github.com:<你的账号>/china-auto-daily.git
git push -u origin main
```
建议用 **SSH key** 或 GitHub PAT，让 `push.sh` 能免密推送。
